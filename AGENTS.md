...
For most changes that do not alter DAG structure or existing operators, open MR and merge. If core DAG/operator behavior changes, open MR and ask for review before merge.
